...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    //Me-register ketika aplikasi dibuka
    override fun onResume() {
        super.onResume()
        preferenceScreen.sharedPreferences.registerOnSharedPreferenceChangeListener(this)
    }

    //Me-unregister ketika aplikasi ditutup
    override fun onPause() {
        super.onPause()
        preferenceScreen.sharedPreferences.unregisterOnSharedPreferenceChangeListener(this)
    }

    //Mengecek apakah ada terjadi perubahan pada data
    ...
    override fun onCreatePreferences(bundle: Bundle?, s: String?) {
        ...
        init() //Memanggil komponen (EditTextPreference dan CheckBoxPreference dari Preference.xml)
        setSummaries() //Merubah Summary-nya
    }
    ...
    //Mengubah Value dari EditTextPreference menjadi nilai yang baru
